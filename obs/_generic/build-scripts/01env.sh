...
### BUILD INFORMATION ###
TARBALL_DIR=${TARBALL_DIR:-$INITIAL_DIR/_tarballs/$SOFTWARE_AND_VERSION}
COMPILATION_FILES_GENERIC_DIR=${COMPILATION_FILES_GENERIC_DIR:-$INITIAL_DIR/_generic/compilation}
COMPILATION_FILES_SOFTWARE_DIR=${COMPILATION_FILES_SOFTWARE_DIR:-$INITIAL_DIR/$SOFTWARE_NAME/compilation}
BUILD_DIR=${BUILD_DIR:-$TARBALL_DIR/build}
RUN_BUILDOUT_DIR=${RUN_BUILDOUT_DIR:-$BUILD_DIR/$TARGET_DIR}
DISTRIB_FILES_GENERIC_DIR=${DISTRIB_FILES_GENERIC_DIR:-$INITIAL_DIR/_generic/distributions}
DISTRIB_FILES_SOFTWARE_DIR=${DISTRIB_FILES_SOFTWARE_DIR:-$INITIAL_DIR/$SOFTWARE_NAME/distributions}

### DISTRIBUTIONS INFORMATION ###
## Maintainance
MAINTAINER_NAME="Maintainer"
MAINTAINER_EMAIL="maintainer@nexedi.com"
CURRENT_DATE="$(date -R)"
## Source package
...
ROLE_IN_SLAPOS=${ROLE_IN_SLAPOS:-software}
NAME_IN_SLAPOS=${NAME_IN_SLAPOS:-$SOFTWARE_NAME}
CFG_NAME=${CFG_NAME:-software.cfg}
BUILDOUT_RELATIVE_PATH=${BUILDOUT_RELATIVE_PATH:-$ROLE_IN_SLAPOS/$NAME_IN_SLAPOS/$CFG_NAME}
BUILDOUT_ENTRY_POINT=${BUILDOUT_ENTRY_POINT:-$BUILDOUT_DIR/$BUILDOUT_RELATIVE_PATH}
## Versions
